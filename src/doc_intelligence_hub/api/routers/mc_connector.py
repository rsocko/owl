...
from doc_intelligence_hub.modules.action_queue.database import Action, get_session as get_aq_session, init_db as aq_init_db
        ...
        return [
            {
                ...
                "document_url": f"{base_url}/documents/{a.document_id}/details" if base_url and a.document_id else None,
            }
            for a in actions
        ]
    finally:
        ...
        try:
            ...
            for eob in eobs:
                ...
                results.append({
                    ...
                    "date_of_service": eob.date_of_service.isoformat() if eob.date_of_service else "",
